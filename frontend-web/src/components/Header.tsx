          ...
          {isAuthenticated ? (
            <div className="flex items-center space-x-4">
              ...
              <div className="relative" ref={dashboardRef}>
                ...
                {isDashboardOpen && (
                  <div className="absolute right-0 w-60 mt-2 bg-white/20 dark:bg-gray-500/50 backdrop-blur-md rounded-lg border border-white/30 dark:border-gray-500/20 shadow-lg overflow-hidden z-50">
                    {user?.role === 'user' && (
                      <Link
                        to="/dashboard"
                        className="flex items-center space-x-3 p-4 text-gray-800 dark:text-gray-200 hover:bg-white/30 dark:hover:bg-gray-500/60 transition-all duration-150"
                        onClick={() => setIsDashboardOpen(false)}
                      >
                        <User className="h-5 w-5 text-emerald-600" />
                        <div>
                    ...
                    {user?.role === 'partner' && (
                      <Link
                        to="/partner-dashboard"
                        className="flex items-center space-x-3 p-4 text-gray-800 dark:text-gray-200 hover:bg-white/30 dark:hover:bg-gray-500/60 border-t border-white/20 dark:border-gray-500/30 transition-all duration-150"
                        onClick={() => setIsDashboardOpen(false)}
                      >
                        <Building className="h-5 w-5 text-blue-600" />
                        <div>
                    ...
                    <button
                      ...
                      className="w-full flex items-center space-x-3 p-4 text-gray-800 dark:text-gray-200 hover:bg-white/30 dark:hover:bg-gray-500/60 border-t border-white/20 dark:border-gray-500/30 text-left transition-all duration-150"
                    >
                      <LogOut className="h-5 w-5 text-red-600" />
                      <div>
                        <div className="font-medium">Log out</div>
